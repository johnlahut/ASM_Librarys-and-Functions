...
;Purpose: Demonstrates use of functions and the Irvine32.lib in assembly 
.386
.model flat, stdcall
...
mov ecx, [ebp+12]			;get function parameter and put it in loop counter reg
...
mov ecx, [ebp+20]			;get function param and put it into loop counter reg
